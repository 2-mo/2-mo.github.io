import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as l,c,f as s,a,b as o,d as p,e as n}from"./app-BTGsX_6R.js";const d={},u=n(`<h1 id="服务器配置及使用" tabindex="-1"><a class="header-anchor" href="#服务器配置及使用"><span>服务器配置及使用</span></a></h1><h2 id="配置基础环境-sudo-用户" tabindex="-1"><a class="header-anchor" href="#配置基础环境-sudo-用户"><span>配置基础环境（sudo 用户）</span></a></h2><h3 id="基础设置" tabindex="-1"><a class="header-anchor" href="#基础设置"><span>基础设置</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token function">vim</span>  <span class="token comment"># 安装vim，vi太难用</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function b(k,h){const e=t("ExternalLinkIcon");return l(),c("div",null,[u,s(" ![image-20230320203122342](步骤.assets/:Users:tiumo:Library:Application Support:typora-user-images:image-20230320203122342.png) "),r,a("p",null,[a("a",m,[o("Miniconda — conda documentation"),p(e)])]),s(' <img src="步骤.assets/:Users:tiumo:Library:Application Support:typora-user-images:image-20230320144038499.png" alt="image-20230320144038499" style="zoom:50%;" /> '),v])}const _=i(d,[["render",b],["__file","index.html.vue"]]),$=JSON.parse(`{"path":"/coding/ubuntu/","title":"服务器配置及使用","lang":"en-US","frontmatter":{"description":"服务器配置及使用 配置基础环境（sudo 用户） 基础设置 配置ssh监控端口 挂载磁盘看情况 安装 cuda 可选 建议安装 11.7 2023-0506 2132 配置conda 下载miniconda Miniconda — conda documentation 终端安装 设置anaconda组 创建新用户 .bashrc .condarc U...","head":[["meta",{"property":"og:url","content":"https://2-mo.github.io/coding/ubuntu/"}],["meta",{"property":"og:site_name","content":"Tiu Mo's Blog"}],["meta",{"property":"og:title","content":"服务器配置及使用"}],["meta",{"property":"og:description","content":"服务器配置及使用 配置基础环境（sudo 用户） 基础设置 配置ssh监控端口 挂载磁盘看情况 安装 cuda 可选 建议安装 11.7 2023-0506 2132 配置conda 下载miniconda Miniconda — conda documentation 终端安装 设置anaconda组 创建新用户 .bashrc .condarc U..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2024-05-11T13:56:36.000Z"}],["meta",{"property":"article:author","content":"Tiu Mo"}],["meta",{"property":"article:modified_time","content":"2024-05-11T13:56:36.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"服务器配置及使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-05-11T13:56:36.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Tiu Mo\\",\\"url\\":\\"https://2-mo.github.io\\"}]}"]]},"headers":[{"level":2,"title":"配置基础环境（sudo 用户）","slug":"配置基础环境-sudo-用户","link":"#配置基础环境-sudo-用户","children":[{"level":3,"title":"基础设置","slug":"基础设置","link":"#基础设置","children":[]},{"level":3,"title":"配置ssh监控端口","slug":"配置ssh监控端口","link":"#配置ssh监控端口","children":[]},{"level":3,"title":"挂载磁盘看情况","slug":"挂载磁盘看情况","link":"#挂载磁盘看情况","children":[]},{"level":3,"title":"安装 cuda 可选","slug":"安装-cuda-可选","link":"#安装-cuda-可选","children":[]},{"level":3,"title":"配置conda","slug":"配置conda","link":"#配置conda","children":[]},{"level":3,"title":"设置anaconda组","slug":"设置anaconda组","link":"#设置anaconda组","children":[]}]},{"level":2,"title":"创建新用户","slug":"创建新用户","link":"#创建新用户","children":[{"level":3,"title":"conda User","slug":"conda-user","link":"#conda-user","children":[]},{"level":3,"title":"免密链接","slug":"免密链接","link":"#免密链接","children":[]}]}],"git":{"createdTime":1715435796000,"updatedTime":1715435796000,"contributors":[{"name":"2-mo","email":"1982800736@qq.com","commits":1}]},"readingTime":{"minutes":3.37,"words":1010},"filePathRelative":"coding/ubuntu/README.md","localizedDate":"May 11, 2024","excerpt":"\\n<h2>配置基础环境（sudo 用户）</h2>\\n<h3>基础设置</h3>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code>$ <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> <span class=\\"token function\\">vim</span>  <span class=\\"token comment\\"># 安装vim，vi太难用</span>\\n\\n$ <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> net-tools\\n\\n$ <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> gpustat\\n\\n$ <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> tmux\\n\\n$ <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> <span class=\\"token function\\">screen</span>\\n</code></pre></div>","autoDesc":true}`);export{_ as comp,$ as data};
