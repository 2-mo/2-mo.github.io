import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as l,c,e as s,a,b as o,d as p,f as n}from"./app-DnGG2Eam.js";const d={},u=n(`<p>测试显卡 import torch print(torch.tensor(45).cuda(1)*torch.tensor(89).cuda(1))</p><h2 id="配置基础环境-sudo-用户" tabindex="-1"><a class="header-anchor" href="#配置基础环境-sudo-用户"><span>配置基础环境（sudo 用户）</span></a></h2><h3 id="基础设置" tabindex="-1"><a class="header-anchor" href="#基础设置"><span>基础设置</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token function">vim</span>  <span class="token comment"># 安装vim，vi太难用</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="挂载磁盘看情况" tabindex="-1"><a class="header-anchor" href="#挂载磁盘看情况"><span>挂载磁盘<code>看情况</code></span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 列出所有磁盘</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="安装-cuda-可选" tabindex="-1"><a class="header-anchor" href="#安装-cuda-可选"><span>安装 cuda <code>可选</code></span></a></h3><p>建议安装 11.7 <code>2023-0506 2132</code></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token string">&#39;https://developer.nvidia.com/cuda-downloads&#39;</span>  <span class="token comment"># 最新版本</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),r=n(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">vim</span> ~/.bashrc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="配置conda" tabindex="-1"><a class="header-anchor" href="#配置conda"><span>配置conda</span></a></h3><h4 id="下载miniconda" tabindex="-1"><a class="header-anchor" href="#下载miniconda"><span>下载miniconda</span></a></h4>`,4),m={href:"https://docs.conda.io/en/latest/miniconda.html",target:"_blank",rel:"noopener noreferrer"},v=n(`<h4 id="终端安装" tabindex="-1"><a class="header-anchor" href="#终端安装"><span>终端安装</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh
...
<span class="token builtin class-name">source</span> ~/.bashrc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">show_channel_urls</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="conda-user" tabindex="-1"><a class="header-anchor" href="#conda-user"><span>conda <mark>User</mark></span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ conda create <span class="token parameter variable">-n</span> <span class="token string">&#39;ENV_NMAE&#39;</span>
...
$ <span class="token function">cat</span> /Users/tiumo/.ssh/id_rsa.pub <span class="token operator">|</span> pbcopy  <span class="token comment"># Mac OS</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function b(k,h){const e=i("ExternalLinkIcon");return l(),c("div",null,[u,s(" ![image-20230320203122342](步骤.assets/:Users:tiumo:Library:Application Support:typora-user-images:image-20230320203122342.png) "),r,a("p",null,[a("a",m,[o("Miniconda — conda documentation"),p(e)])]),s(' <img src="步骤.assets/:Users:tiumo:Library:Application Support:typora-user-images:image-20230320144038499.png" alt="image-20230320144038499" style="zoom:50%;" /> '),v])}const _=t(d,[["render",b],["__file","index.html.vue"]]),x=JSON.parse(`{"path":"/coooder/ubuntu/","title":"服务器配置及使用","lang":"en-US","frontmatter":{"title":"服务器配置及使用","order":1,"description":"测试显卡 import torch print(torch.tensor(45).cuda(1)*torch.tensor(89).cuda(1)) 配置基础环境（sudo 用户） 基础设置 配置ssh监控端口 挂载磁盘看情况 安装 cuda 可选 建议安装 11.7 2023-0506 2132 配置conda 下载miniconda Minicon...","head":[["meta",{"property":"og:url","content":"https://2-mo.github.io/coooder/ubuntu/"}],["meta",{"property":"og:site_name","content":"Tiu Mo's Blog"}],["meta",{"property":"og:title","content":"服务器配置及使用"}],["meta",{"property":"og:description","content":"测试显卡 import torch print(torch.tensor(45).cuda(1)*torch.tensor(89).cuda(1)) 配置基础环境（sudo 用户） 基础设置 配置ssh监控端口 挂载磁盘看情况 安装 cuda 可选 建议安装 11.7 2023-0506 2132 配置conda 下载miniconda Minicon..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2025-05-26T01:26:00.000Z"}],["meta",{"property":"article:author","content":"Tiu Mo"}],["meta",{"property":"article:modified_time","content":"2025-05-26T01:26:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"服务器配置及使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-05-26T01:26:00.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Tiu Mo\\",\\"url\\":\\"https://2-mo.github.io\\"}]}"]]},"headers":[{"level":2,"title":"配置基础环境（sudo 用户）","slug":"配置基础环境-sudo-用户","link":"#配置基础环境-sudo-用户","children":[{"level":3,"title":"基础设置","slug":"基础设置","link":"#基础设置","children":[]},{"level":3,"title":"配置ssh监控端口","slug":"配置ssh监控端口","link":"#配置ssh监控端口","children":[]},{"level":3,"title":"挂载磁盘看情况","slug":"挂载磁盘看情况","link":"#挂载磁盘看情况","children":[]},{"level":3,"title":"安装 cuda 可选","slug":"安装-cuda-可选","link":"#安装-cuda-可选","children":[]},{"level":3,"title":"配置conda","slug":"配置conda","link":"#配置conda","children":[]},{"level":3,"title":"设置anaconda组","slug":"设置anaconda组","link":"#设置anaconda组","children":[]}]},{"level":2,"title":"创建新用户","slug":"创建新用户","link":"#创建新用户","children":[{"level":3,"title":"conda User","slug":"conda-user","link":"#conda-user","children":[]},{"level":3,"title":"免密链接","slug":"免密链接","link":"#免密链接","children":[]}]}],"git":{"createdTime":1715435796000,"updatedTime":1748222760000,"contributors":[{"name":"2-mo","email":"1982800736@qq.com","commits":1},{"name":"Tiu Mo","email":"1982800736@qq.com","commits":1}]},"readingTime":{"minutes":3.44,"words":1033},"filePathRelative":"coooder/ubuntu/README.md","localizedDate":"May 11, 2024","excerpt":"<p>测试显卡\\nimport torch\\nprint(torch.tensor(45).cuda(1)*torch.tensor(89).cuda(1))</p>\\n<h2>配置基础环境（sudo 用户）</h2>\\n<h3>基础设置</h3>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code><span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> <span class=\\"token function\\">vim</span>  <span class=\\"token comment\\"># 安装vim，vi太难用</span>\\n\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> net-tools\\n\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> gpustat\\n\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> tmux\\n\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">apt</span> <span class=\\"token function\\">install</span> <span class=\\"token function\\">screen</span>\\n</code></pre></div>","autoDesc":true}`);export{_ as comp,x as data};
