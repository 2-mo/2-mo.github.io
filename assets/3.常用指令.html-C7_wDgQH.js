import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as i,c as l,a as n,b as c,d as p,f as s}from"./app-BpePyK3c.js";const o={},r=s(`<h4 id="使用国内镜像源" tabindex="-1"><a class="header-anchor" href="#使用国内镜像源"><span>使用国内镜像源</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ pip3 <span class="token function">install</span> pk_name<span class="token punctuation">(</span>要安装的包<span class="token punctuation">)</span> <span class="token parameter variable">-i</span> https://pypi.tuna.tsinghua.edu.cn/simple
