import{_ as i,X as t,Y as l,a3 as s,a1 as a,a2 as c,Z as o,a0 as n,E as p}from"./framework-84dd2d5e.js";const d={},u=n(`<h1 id="服务器配置及使用" tabindex="-1"><a class="header-anchor" href="#服务器配置及使用" aria-hidden="true">#</a> 服务器配置及使用</h1><h2 id="配置基础环境-sudo-用户" tabindex="-1"><a class="header-anchor" href="#配置基础环境-sudo-用户" aria-hidden="true">#</a> 配置基础环境（sudo 用户）</h2><h3 id="基础设置" tabindex="-1"><a class="header-anchor" href="#基础设置" aria-hidden="true">#</a> 基础设置</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token function">vim</span>  <span class="token comment"># 安装vim，vi太难用</span>
