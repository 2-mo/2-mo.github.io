import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as i,f as a}from"./app-B5wUlprO.js";const s={},t=a(`<ol><li>/userdata/archiconda3/etc/profile.d/conda.sh</li><li>/userdata/archiconda3/bin/conda</li><li>/opt/miniconda3/bin/conda-env</li><li>/userdata/archiconda3/bin/activate</li><li>/userdata/archiconda3/bin/deactivate</li><li>/userdata/archiconda3/bin/pip</li><li>/userdata/archiconda3/bin/pip3</li><li>/userdata/archiconda3/envs/&#39;YOURENVNAME&#39;/bin/pip</li></ol><p>$ source ~/.bashrc</p><p>上面一堆坑，别弄！</p><p>为了使多个用户共享环境，可以做一下设置</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>groupadd anaconda  # 创建anaconda组
